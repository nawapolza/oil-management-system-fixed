...
export default function UsersPage() {
  ...
  return (
    <div className="page-shell">
      <div className="hero-clean relative overflow-hidden">
        <div className="relative z-10"><p className="text-xs font-black uppercase tracking-[.22em] text-cyan-200">Team & access</p>
        <h1 className="mt-2 text-2xl font-black md:text-3xl">จัดการพนักงาน</h1>
        <p className="page-subtitle">แยกสิทธิ์ Owner และ Employee ชัดเจน พนักงานจะไม่เห็น Dashboard</p>
        </div><div className="pointer-events-none absolute -right-8 -top-10 h-40 w-40 rounded-full bg-cyan-400/20 blur-2xl" />
      </div>
